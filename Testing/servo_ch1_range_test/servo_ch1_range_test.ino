/*
 * CYNEXIS — PCA9685 CH1 Expanded Range Test (60° -> 90° -> 120° -> 90°)
 * 
 * Hardware Configuration:
 *   - ESP32: SDA = GPIO 21, SCL = GPIO 22
 *   - PCA9685: Address 0x40
 *   - Target Channel: CH1 ONLY (MG996R #1)
 *   - Power: XL4016 = 5.00V External Servo Supply
 *   - Horn Status: DETACHED (Unloaded safety)
 * 
 * Sequence:
...
void setup() {
  ...
  Serial.println("\n==========================================");
  Serial.println(" CYNEXIS — PCA9685 CH1 RANGE TEST (60-120°) ");
  Serial.println("==========================================");
  ...
  Serial.println("\n[SETUP] Initializing CH1 to 90° Center...");
  setServoAngle(90.0);
  delay(2000);
}

void loop() {
  Serial.println("\n--- Starting Expanded Range Test ---");
